...
namespace LanchesMac.Migrations
{
    ...
    public partial class PopularLanches : Migration
    {
        ...
        {
            migrationBuilder.Sql("DELETE FROM Lanches WHERE Nome = 'Cheese Salada'");
            migrationBuilder.Sql("DELETE FROM Lanches WHERE Nome = 'Misto Quente'");
            migrationBuilder.Sql("DELETE FROM Lanches WHERE Nome = 'Cheese Burger'");
            migrationBuilder.Sql("DELETE FROM Lanches WHERE Nome = 'Lanche Natural Peito Peru'");
        }
    }
}
